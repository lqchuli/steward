...
import com.lingyu.steward.manager.config.security.StewardAuthenticationProcessingFilter;
import com.lingyu.steward.manager.config.security.StewardAuthenticationProvider;
import com.lingyu.steward.service.common.AuthorityEnum;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private StewardAuthenticationProcessingFilter stewardAuthenticationProcessingFilter() {
        ...
        authenticationProvider.setManagerUserDetailsService(null);
        authenticationProvider.setDecorationUserDetailsService(null);
        // TODO: 10/11/2017 UserDetailsService代添加
        ...
        return stewardAuthenticationProcessingFilter();
    }
